...
def SearchForm(
    ...
    def extract_fields( filters, flattened_filters ):  # works recursively
        ...
        for nr, filter in enumerate(filters):
            ...
            if isinstance(filter, (list, tuple)):  # if we get a row of filters
                fields.append( extract_fields( filter , flattened_filters ))  # apply recursively
    ...
    fields = extract_fields( filters, flattened_filters )
